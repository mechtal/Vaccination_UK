...
```{r ModelSouthWestScatterPlot1, echo=FALSE}
...
```{r ModelSouthWestScatterPlot2, echo=FALSE}
ggplot(data = py$dataset, 
        aes(x=First, 
        y=DayOfYear)
) +
...
```{r ModelSouthWestScatterPlot3, echo=FALSE}
ggplot(data = py$dataset, 
        aes(x=First, 
        y=Month)
) +
...
```{python ModelSouthWestTreeDt, echo=FALSE, fig.align = "center"}
plt.figure(figsize=(60, 40))
# feature_columns is defined above
tree.plot_tree(model_dt, max_depth=2, feature_names=feature_columns)
```

```{python ModelSouthWestTreeRf, echo=FALSE, fig.align = "center"}
plt.figure(figsize=(60,40))
# feature_columns is defined above
...
```{python ModelSouthWestSecond, include=FALSE}
y_column = "Second"
```
```{python ModelSouthWestSecondTrainAll, echo=FALSE}
<<ModelSouthWestAllColumns>>
<<ModelSouthWestTrainAll>>
#<<tree_dt>>
#<<tree_rf>>
<<ModelSouthWestPlotAll>>
...
\newpage
```{python ModelSouthWestSecondTrainMy, echo=FALSE}
<<ModelSouthWestMyColumns>>
<<ModelSouthWestTrainAll>>
#<<tree_dt>>
#<<tree_rf>>
<<ModelSouthWestPlotAll>>
...
\newpage
```{python ModelSouthWestSecondTrainCorrelations, echo=FALSE}
<<ModelSouthWestCorrelationsColumns>>
<<ModelSouthWestTrainAll>>
#<<tree_dt>>
#<<tree_rf>>
<<ModelSouthWestPlotAll>>
...
**Repeat for Third**
```{python ModelSouthWestThird, include=FALSE}
y_column = "Third"
```
```{python ModelSouthWestThirdTrainAll, echo=FALSE}
<<ModelSouthWestAllColumns>>
<<ModelSouthWestTrainAll>>
#<<tree_dt>>
#<<tree_rf>>
...
\newpage
```{python ModelSouthWestThirdTrainMy, echo=FALSE}
<<ModelSouthWestMyColumns>>
<<ModelSouthWestTrainAll>>
#<<tree_dt>>
#<<tree_rf>>
