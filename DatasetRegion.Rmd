...
```{r DatasetSouthWestNewColumnMonthYear, include=FALSE}
# add columns
...
```{r DatasetSouthWestLongVariables, include=FALSE}
...
```{r DatasetSouthWestAllDosesPlot, echo=FALSE, fig.cap = "\\label{fig:AllDosesPlot} My caption"}
...
\newpage
```{r DatasetSouthWestFirst, echo=FALSE}
...
```{r DatasetSouthWestLongSummarise, include=FALSE}
...
\newpage
```{r DatasetSouthWestDosesWaves, fig.cap = "\\label{fig:DosesWaves} My caption", echo=FALSE}
...
- If we look at "Q0.25", "Q0.75", "Q0.90", we find out that the Third dose's wave caught up with other doses' waves quickly. We already saw this fact on the plot \@ref(fig:DatasetSouthWestAllDosesPlot).
